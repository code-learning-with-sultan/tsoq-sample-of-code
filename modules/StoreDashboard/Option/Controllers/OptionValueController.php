...
use Modules\StoreDashboard\Option\Repositories\OptionValueRepository;

class OptionValueController extends Controller
{

    public function __construct(private OptionValueRepository $OptionRepository)
    {
    ...
    {
        return $this->OptionRepository->all($request);
    }
